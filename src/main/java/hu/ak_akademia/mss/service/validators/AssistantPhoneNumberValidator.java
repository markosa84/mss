...
class AssistantPhoneNumberValidator implements Validator<Assistant> {
    ...
    public void validate(Assistant assistant) throws IncorrectEnteredDataException {
        if (assistant.getPhoneNumber() == null || !assistant.getPhoneNumber().matches(PHONE_NUMBER_REGEX)) {
